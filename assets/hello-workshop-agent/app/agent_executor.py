...
from tools import greet_participant, answer_question, provide_guidance, complete_session
...
class AgentExecutor(A2AAgentExecutor):
    ...
    async def execute(self, context: RequestContext, event_queue: EventQueue) -> None:
        ...
        workshop_tools = [greet_participant, answer_question, provide_guidance, complete_session]
        tools = [*tools, *self.skill_tools, *workshop_tools]
