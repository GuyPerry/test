...
def main(host: str, port: int):
    skill = AgentSkill(
        id="hello-workshop-agent",
        name="hello-workshop-agent",
        description="A friendly AI agent that greets, guides, and assists workshop participants through interactive Q&A and step-by-step navigation.",
        tags=["hello", "workshop", "agent"],
        examples=["Greet me as a workshop participant", "What are the next steps in this workshop?"],
    )
